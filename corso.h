...
//POST: calcola la percentuale di superamento di un dato esame
//(solo guardando gli studenti che hanno conseguito un voto, chi non ha 
//fatto l'esame non è contato)
...
//NOTA: l'algoritmo di ordinamento da utilizzare è a vostra discrezione.
//E' consentito riadattare gli esercizi sul mergesort o sul quicksort se
//volete